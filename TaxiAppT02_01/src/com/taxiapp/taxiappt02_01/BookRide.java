...
public class BookRide extends TableLayout{
	...
	public BookRide(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	public BookRide(Context context){
		super(context);
		init(context);
	}
	...
	{
		CalendarDB db = new CalendarDB(context);
	...
	void DisplayMonth(boolean animationEnabled)
	{
		...
		RelativeLayout rl = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.activity_book_ride, null);
		...
		btn = (TextView) rl.findViewById(R.id.txtMonth);
