...
public class TaxiRideInformation {
    ...
    public String getDate() { return datebookedfor; }
    ...
    public void setDate(String str) { datebookedfor = str; }
    public void setTime(String str) { timebookedfor = str; }
    public void setStartAddress(String str) { startaddress = str; }
    public void setEndAddress(String str) { endaddress = str; }
    public void setEstimatedCost(String str) { estimatedcost = str; }
    public void setTaxisharers(String str) { taxisharers = str; }
}
